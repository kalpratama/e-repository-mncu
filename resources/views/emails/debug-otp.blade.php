                    ...
                    <tr>
                        <td style="padding: 35px 30px; text-align: center; color: #333;">
                            ...
                            <p style="font-size: 16px; margin: 12px 0 20px; color: #555;">
                                Kode OTP berikut tidak memiliki fungsi dan hanya digunakan untuk tujuan <strong>debugging</strong>.
                            </p>
                            ...
                            <p style="font-size: 13px; margin-top: 20px; color: #888;">
                                Kode ini tidak akan kedaluwarsa dalam <strong>10 menit</strong>,  
                                karena kode ini hanya untuk debugging.
                            </p>
                        </td>
                    </tr>
